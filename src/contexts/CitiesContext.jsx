...
function CitiesProvider({ children }) {
  ...
  //acá se usa el useCallback para evitar el infinite loop en City.jsx (se estabiliza la función para evitar re-renders innecesarios)
  ...
  return (
    <CitiesContext.Provider value={{ cities, isLoading, formatDate, currentCity, getCity, createCity, deleteCity }}>
      {children}
